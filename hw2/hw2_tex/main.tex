...
\begin{itemize}
    ...
    \item \textbf{Skeleton codes:} The python files, \textcolor{blue}{data.py} and \textcolor{blue}{soft\_svm.py} can be found at \url{https://github.com/ShenghaoWu/10715/tree/master/hw2}
\end{itemize}
